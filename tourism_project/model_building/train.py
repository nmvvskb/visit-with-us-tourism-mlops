...
mlflow.set_experiment("visit_with_us_toursim_experiment_prod")

api = HfApi()


Xtrain_path = "hf://datasets/nmvvskb/visit-with-us-tourism-mlops/Xtrain.csv"
Xtest_path = "hf://datasets/nmvvskb/visit-with-us-tourism-mlops/Xtest.csv"
ytrain_path = "hf://datasets/nmvvskb/visit-with-us-tourism-mlops/ytrain.csv"
ytest_path = "hf://datasets/nmvvskb/visit-with-us-tourism-mlops/ytest.csv"
...
numeric_features = [
    'CityTier', 'DurationOfPitch', 'NumberOfPersonVisiting',
    'NumberOfFollowups', 'PreferredPropertyStar', 'NumberOfTrips', 'Age',
    'Passport', 'PitchSatisfactionScore', 'OwnCar','NumberOfChildrenVisiting', 'MonthlyIncome'
]

categorical_features = [
    'TypeofContact', 'Gender', 'ProductPitched', 'Designation', 'MaritalStatus', 'Occupation'
]
...
with mlflow.start_run():
    ...
    repo_id = "nmvvskb/best_tourism_model"
    repo_type = "model"
